...
// verification des champs de saisis nom,prenom, email, phone et password et confirmation du password
//creation de l utisateur
...
// authentification de l utilisateur et verification 
...
app.get("/api/user/profile",checkJwt,async(req,res)=>{
 ...
 // route de modification d'un compte utilisateur
 ...
 // route de modification du password
  ...
  app.put("/api/user/edit-password", checkJwt , async (req, res) => {
    ...
    res.status(201).json({
     ...
     // route de modification du telephone
    ...
    app.put("/api/user/edit-phone", checkJwt , async (req, res) => {
      ...
      res.status(201).json({
       ...
       // route de modification de l email
...
// route de suppression d'un compte utilisateur avec confirmation par email
